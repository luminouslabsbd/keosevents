...
class AppServices {
    ...
    public function getVenues($criterias) {
        ...
        $organizerEnabled = array_key_exists('organizerEnabled', $criterias) ? $criterias['organizerEnabled'] : "all";
    ...
    public function getCurrentRequestProtocol() {
